...
Station.prototype.start = function () {
  var self = this;
  this.io = socketio.listen(this.listener, {
    log: false
  });
  ...
  this.pusher = new Worker(this.servers, 3 * 1000, function (servers) {
...
Station.prototype.sendStats = function (client) {
  var self = this;
  this.redis.hgetall(outils.getHashDate(), function (err, data) {
    if (client !== undefined) {
